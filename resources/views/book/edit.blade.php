                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                                       name="description" value="{{ $book->description }}" required autocomplete="description" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="book_number" type="text" class="form-control @error('book_number') is-invalid @enderror"
                                       name="book_number" value="{{ $book->book_number }}" required autocomplete="book_number" autofocus>
                            ...
                            <div class="col-md-6">
                                <select id="author" name="author_id"  class="form-control @error('author_id') is-invalid @enderror">
                                    @foreach($authors as $author)
                                        <option value="{{$author->id}}" @if($book->author_id == $author->id) selected @endif>{{$author->fullName}}</option>
                                    @endforeach
                                </select>
                                @error('author_id')
                                <span class="invalid-feedback d-block" role="alert">
