                    ...
                    <form method="POST" action="{{ route('authors.update', $author->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror"
                                       name="first_name" value="{{ $author->first_name }}" required autocomplete="first_name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror"
                                       name="last_name" value="{{ $author->last_name }}" required autocomplete="last_name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($author->image)
                                <img id="photo-preview" width="50" src="{{$author->fullPathImage}}">
                                @endif
